    ...
    fire: function () {
        ...
        klevu.search.landing.getScope().chains.template.events.add({
            ...
            fire: function (data, scope) {
                ...
                klevu.event.attach(klevu.dom.find('#loadMore')[0], "click", function (event) {
                    ...
                    var offset = event.target.dataset.value;
        ...
        klevu.search.landing.getScope().chains.template.render.add({
            ...
            fire: function (data, scope) {
                if (data.context.isSuccess) {
                    ...
                    if (klevu.dom.find('.kuResults').length > 0) {
                    ...
                    klevu.dom.find('#loadMore')[0].dataset.value = offset;
                }
            }
        });
    }
